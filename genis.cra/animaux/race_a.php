...
<head>
	...
	<!-- Page crée par les NumAg 2019
		Cette page contient l'export fiche race avec les tableaux et graphiques des effectis, des naisances et des présences dans la race---->
  <title>GenIS</title>
...
<div class="col-md-12">
	...
	<div class="widget-content">
        <div class="padd">
          <?php
//Récupération de la race et de la période choisies dans le formulaire de la page visuRace.php
$code_race = $_GET["race"];
$annee1 = $_GET["annee1"];
$annee2 = $_GET["annee2"];
...
//Affichage des titres (années) dans la 1ère ligne du tableau
	echo "<thead><tr><td></td>";
	for($i=$annee1;$i<=$annee2;$i++)
	{
		echo "<td>";
...
$nb_femelle[0]="Totale femelles inventoriées";
	//Boucle pour effectuer la requête pour chaque année
	for($i=$annee1;$i<=$annee2;$i++)
	{
		//Requête pour récupérer les effectifs de femelles à l'aide d'une fonction SQL
